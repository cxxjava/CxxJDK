...
public:
	 ...
	 *
	 */
	static ESocket* createFromFD(int fd, boolean connected, boolean bound, int raddr=0, int rport=0) THROWS(EIOException);
...
protected:
     ...
     */
	ESocket(const int fd, boolean connected, boolean bound, int raddr=0, int rport=0) THROWS(EIOException);
