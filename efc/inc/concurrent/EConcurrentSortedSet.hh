#ifndef __ECONCURRENTSORTEDSET_HH__
#define __ECONCURRENTSORTEDSET_HH__
...
template<typename E>
interface EConcurrentSortedSet : virtual public EConcurrentSet<E>
{
	virtual ~EConcurrentSortedSet(){}
...
#endif //!__ECONCURRENTSORTEDSET_HH__
