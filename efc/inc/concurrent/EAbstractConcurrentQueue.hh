/*
 * EAbstractConcurrentQueue.hh
 *
 *  Created on: 2014-6-27
 *      Author: cxxjava@163.com
 */

#ifndef EABSTRACT_CONCURRENT_QUEUE_HH_
#define EABSTRACT_CONCURRENT_QUEUE_HH_
...
template<typename E>
abstract class EAbstractConcurrentQueue: virtual public EAbstractConcurrentCollection<E>,
		virtual public EConcurrentQueue<E> {
protected:
	/**
	 * Constructor for use by subclasses.
	 */
	EAbstractConcurrentQueue() {
	}

public:
	virtual ~EAbstractConcurrentQueue(){}
	...
	virtual boolean remove(E* o) {
		return EAbstractConcurrentCollection<E>::remove(o);
	}
...
#endif /* EABSTRACT_CONCURRENT_QUEUE_HH_ */
