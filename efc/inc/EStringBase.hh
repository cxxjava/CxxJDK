...
public:
	...
	explicit EStringBase(short i, int radix = 10);
	explicit EStringBase(ushort i, int radix = 10);
	explicit EStringBase(int i, int radix = 10);
	explicit EStringBase(uint i, int radix = 10);
	explicit EStringBase(long l, int radix = 10);
	explicit EStringBase(ulong l, int radix = 10);
	explicit EStringBase(llong ll, int radix = 10);
	explicit EStringBase(ullong ll, int radix = 10);
...
public:
	...
	EStringBase& append(short i, int radix = 10);
	EStringBase& append(ushort i, int radix = 10);
	EStringBase& append(int i, int radix = 10);
	EStringBase& append(uint i, int radix = 10);
	EStringBase& append(long l, int radix = 10);
	EStringBase& append(ulong l, int radix = 10);
	EStringBase& append(llong l, int radix = 10);
	EStringBase& append(ullong l, int radix = 10);
