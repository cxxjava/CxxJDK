...
template<typename T>
abstract class EAbstractQueue<T*>: virtual public EAbstractCollection<T*>,
		virtual public EQueue<T*> {
public:
	typedef T* E;
...
template<typename T>
abstract class EAbstractQueue<sp<T> >: virtual public EAbstractCollection<sp<T> >,
		virtual public EQueue<sp<T> > {
public:
	typedef sp<T> E;
