/**
 * @file  eso_locale_str.h
 * @brief ES Locale string.
 */

#ifndef __ESO_LOCALE_STR_H__
#define __ESO_LOCALE_STR_H__

/*
 * Mappings from partial locale names to full locale names
 */
 static const char *eso_locale_aliases[] = {
    "ar", "ar_EG",
    "be", "be_BY",
    "bg", "bg_BG",
    "br", "br_FR",
 ...
 */
static const char *eso_language_names[] = {
    "C", "en",
    "POSIX", "en",
    "cz", "cs",
    "he", "iw",
 ...
 */
static const char *eso_script_names[] = {
#ifdef __linux__
    "cyrillic", "Cyrl",
    "devanagari", "Deva",
    "iqtelif", "Latn",
 ...
 */
static const char *eso_country_names[] = {
#ifdef __linux__
 ...
 */
static const char *eso_variant_names[] = {
    "nynorsk", "NY",
    "",
};

#endif /* __ESO_LOCALE_STR_H__ */
