...
#ifndef ESocketOptions_HH_
#define ESocketOptions_HH_
...
interface ESocketOptions : virtual public EObject {
     ...
     * @see #getOption(int)
     */
    virtual void setOption(int optID, const void* optval, int optlen) THROWS(ESocketException) = 0;
     ...
     */
    virtual void getOption(int optID, void* optval, int* optlen) THROWS(ESocketException) = 0;
    ...
    const static int _TCP_NODELAY;// = 0x0001;
    ...
    const static int _SO_REUSEADDR;// = 0x0004;
    ...
    const static int _SO_BROADCAST;// = 0x0020;
    ...
    const static int _IP_MULTICAST_IF;// = 0x10;
     ...
     * @since 1.4
     */
    const static int _IP_MULTICAST_IF2;// = 0x1f;
    ...
    const static int _IP_MULTICAST_LOOP;// = 0x12;
     ...
     */
    const static int _SO_LINGER;// = 0x0080;
     ...
     */
    const static int _SO_TIMEOUT;// = 0x1006;
     ...
     */
    const static int _SO_SNDBUF;// = 0x1001;
     ...
     */
    const static int _SO_RCVBUF;// = 0x1002;
     ...
     */
    const static int _SO_KEEPALIVE;// = 0x0008;
