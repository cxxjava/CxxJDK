...
#define ENONWRITABLECHANNELEXCEPTIONS(msg) ENonWritableChannelException(msg, __FILE__, __LINE__, errno)
...
public:
	 ...
	 */
	ENonWritableChannelException(const char *s, const char *_file_, int _line_,
			int errn = 0) :
