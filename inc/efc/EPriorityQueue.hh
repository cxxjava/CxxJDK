...
public:
    ...
    EPriorityQueue() :
        ...
        this->queue = new EA<E>(DEFAULT_INITIAL_CAPACITY);
    }
     ...
     */
	explicit
	EPriorityQueue(int initialCapacity, EComparator<E>* comparator) :
			_size(0), modCount(0) {
...
template<typename T>
class EPriorityQueue<T*>: public EAbstractQueue<T*> {
public:
	typedef T* E;
...
template<typename T>
class EPriorityQueue<sp<T> >: public EAbstractQueue<sp<T> > {
public:
	typedef sp<T> E;
