/*
 * ESequenceInputStream.hh
 *
 *  Created on: 2013-7-24
 *      Author: cxxjava@163.com
 */

#ifndef ESEQUENCEINPUTSTREAM_HH_
#define ESEQUENCEINPUTSTREAM_HH_
...
class ESequenceInputStream: public EInputStream {
public:
	virtual ~ESequenceInputStream();
	 ...
	 */
	ESequenceInputStream(EEnumeration<EInputStream*>* e);
	 ...
	 */
	ESequenceInputStream(EInputStream* s1, EInputStream* s2);
...
protected:
	 ...
	 */
	void nextStream() THROWS(EIOException);

private:
	EVector<EInputStream*>* _v;
};

} /* namespace efc */
#endif /* ESEQUENCEINPUTSTREAM_HH_ */
