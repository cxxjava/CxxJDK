 ...
 * sample:
 EString getDateString(llong time) {
	...
	str = EInteger::toString(calendar->get(ECalendar::YEAR)) + "年"
		+ EInteger::toString(calendar->get(ECalendar::MONTH)+1) + "月"
		+ EInteger::toString(calendar->get(ECalendar::DATE)+1) + "日"
		+ (calendar->get(ECalendar::AM_PM)==ECalendar::PM ? "下午" : "上午")
		+ EInteger::toString(calendar->get(ECalendar::HOUR)) + "时"
		+ EInteger::toString(calendar->get(ECalendar::MINUTE)) + "分"
		+ EInteger::toString(calendar->get(ECalendar::SECOND)) + "秒";
