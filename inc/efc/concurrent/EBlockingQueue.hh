...
interface EBlockingQueue : virtual public EConcurrentQueue<E>
{
	 ...
	 * @throws InterruptedException if interrupted while waiting
	 */
	virtual sp<E> take() THROWS(EInterruptedException) = 0;

	/**
	 * {@inherit from super for c++ hides overloaded virtual function}
	 */
	virtual sp<E> poll() {return sp<E>::nullPtr();}
	 ...
	 * @throws InterruptedException if interrupted while waiting
	 */
	virtual sp<E> poll(llong timeout, ETimeUnit* unit) THROWS(EInterruptedException) = 0;
