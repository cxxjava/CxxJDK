#ifndef __ECONCURRENTSORTEDMAP_HH__
#define __ECONCURRENTSORTEDMAP_HH__
...
interface EConcurrentSortedMap : virtual public EConcurrentMap<K,V>
{
	virtual ~EConcurrentSortedMap(){}
     ...
     */
    virtual EConcurrentSortedMap<K,V>* subMap(K* fromKey, K* toKey) = 0;
     ...
     *         bounds of the range
     */
    virtual EConcurrentSortedMap<K,V>* headMap(K* toKey) = 0;
     ...
     *         bounds of the range
     */
    virtual EConcurrentSortedMap<K,V>* tailMap(K* fromKey) = 0;
...
#endif //!__ECONCURRENTSORTEDMAP_HH__
