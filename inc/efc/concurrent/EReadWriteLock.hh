...
interface EReadWriteLock : virtual public EObject
{
	virtual ~EReadWriteLock(){}
	 ...
	 */
	virtual ELock* writeLock() = 0;
};

} /* namespace efc */
#endif /* EREADWRITELOCK_HH_ */
