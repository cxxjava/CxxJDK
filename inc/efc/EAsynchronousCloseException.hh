...
#define EASYNCHRONOUSCLOSEEXCEPTIONS(msg) EAsynchronousCloseException(msg, __FILE__, __LINE__, errno)
...
public:
	 ...
	 */
	EAsynchronousCloseException(const char *s, const char *_file_, int _line_, int errn =
			0) :
				EClosedChannelException(s, _file_, _line_, errn) {
	}
};
