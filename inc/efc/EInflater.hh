...
#ifndef EINFLATER_HH_
#define EINFLATER_HH_
...
public:
	 ...
	 */
	EInflater(boolean nowrap=false);
	 ...
	 */
	void setDictionary(byte* b, int len);
	 ...
	 * @see Inflater#needsDictionary
	 */
	int inflate(byte* b, int len) THROWS (EDataFormatException);
