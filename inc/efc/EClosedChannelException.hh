...
#define ECLOSEDCHANNELEXCEPTIONS(msg) EClosedChannelException(msg, __FILE__, __LINE__, errno)
...
public:
	 ...
	 */
	EClosedChannelException(const char *s, const char *_file_, int _line_, int errn =
			0) :
